...
.binaryTarget(
    name: "Concorde",
    url: "https://github.com/macmoonshine/concorde/releases/download/v1.0.0/Concorde.xcframework.zip",
    checksum: "..."
)
```

Replace the checksum value with the contents of [`Concorde.xcframework.cksum`](https://github.com/macmoonshine/concorde/blob/v1.0.0/Concorde.xcframework.cksum) from the corresponding release.
